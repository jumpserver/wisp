...
var file_service_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x22, 0x07, 0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0x86, 0x09, 0x0a, 0x07,
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x47, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x44, 0x42,
	...
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x18, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x44,
	0x42, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00,
...
var file_service_proto_goTypes = []interface{}{
	...
	(*TokenAuthInfo)(nil),            // 31: message.TokenAuthInfo
	(*Session)(nil),                  // 32: message.Session
	(RiskLevel)(0),                   // 33: message.RiskLevel
	(*TerminalTask)(nil),             // 34: message.TerminalTask
	(*Gateway)(nil),                  // 35: message.Gateway
	(*PublicSetting)(nil),            // 36: message.PublicSetting
}
var file_service_proto_depIdxs = []int32{
	...
	31, // 3: message.DBTokenResponse.data:type_name -> message.TokenAuthInfo
	32, // 4: message.SessionCreateRequest.data:type_name -> message.Session
	3,  // 5: message.SessionCreateResponse.status:type_name -> message.Status
	32, // 6: message.SessionCreateResponse.data:type_name -> message.Session
	3,  // 7: message.SessionFinishResp.status:type_name -> message.Status
	3,  // 8: message.ReplayResponse.status:type_name -> message.Status
	33, // 9: message.CommandRequest.risk_level:type_name -> message.RiskLevel
	3,  // 10: message.CommandResponse.status:type_name -> message.Status
	34, // 11: message.TaskResponse.task:type_name -> message.TerminalTask
	...
	35, // 22: message.ForwardRequest.gateways:type_name -> message.Gateway
	...
	36, // 25: message.PublicSettingResponse.data:type_name -> message.PublicSetting
	4,  // 26: message.Service.GetDBTokenAuthInfo:input_type -> message.TokenRequest
	4,  // 27: message.Service.RenewToken:input_type -> message.TokenRequest
	6,  // 28: message.Service.CreateSession:input_type -> message.SessionCreateRequest
	8,  // 29: message.Service.FinishSession:input_type -> message.SessionFinishRequest
	10, // 30: message.Service.UploadReplayFile:input_type -> message.ReplayRequest
	12, // 31: message.Service.UploadCommand:input_type -> message.CommandRequest
	14, // 32: message.Service.DispatchTask:input_type -> message.FinishedTaskRequest
	16, // 33: message.Service.ScanRemainReplays:input_type -> message.RemainReplayRequest
	19, // 34: message.Service.CreateCommandTicket:input_type -> message.CommandConfirmRequest
	1,  // 35: message.Service.CheckOrCreateAssetLoginTicket:input_type -> message.AssetLoginTicketRequest
	23, // 36: message.Service.CheckTicketState:input_type -> message.TicketRequest
	23, // 37: message.Service.CancelTicket:input_type -> message.TicketRequest
	26, // 38: message.Service.CreateForward:input_type -> message.ForwardRequest
	27, // 39: message.Service.DeleteForward:input_type -> message.ForwardDeleteRequest
	30, // 40: message.Service.GetPublicSetting:input_type -> message.Empty
	5,  // 41: message.Service.GetDBTokenAuthInfo:output_type -> message.DBTokenResponse
	18, // 42: message.Service.RenewToken:output_type -> message.StatusResponse
	7,  // 43: message.Service.CreateSession:output_type -> message.SessionCreateResponse
	9,  // 44: message.Service.FinishSession:output_type -> message.SessionFinishResp
	11, // 45: message.Service.UploadReplayFile:output_type -> message.ReplayResponse
	13, // 46: message.Service.UploadCommand:output_type -> message.CommandResponse
	15, // 47: message.Service.DispatchTask:output_type -> message.TaskResponse
	17, // 48: message.Service.ScanRemainReplays:output_type -> message.RemainReplayResponse
	21, // 49: message.Service.CreateCommandTicket:output_type -> message.CommandConfirmResponse
	2,  // 50: message.Service.CheckOrCreateAssetLoginTicket:output_type -> message.AssetLoginTicketResponse
	24, // 51: message.Service.CheckTicketState:output_type -> message.TicketStateResponse
	18, // 52: message.Service.CancelTicket:output_type -> message.StatusResponse
	28, // 53: message.Service.CreateForward:output_type -> message.ForwardResponse
	18, // 54: message.Service.DeleteForward:output_type -> message.StatusResponse
	29, // 55: message.Service.GetPublicSetting:output_type -> message.PublicSettingResponse
