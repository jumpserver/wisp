...
type TicketInfo struct {
	...
	ConfirmReq      *ReqInfo `protobuf:"bytes,1,opt,name=confirm_req,json=confirmReq,proto3" json:"confirm_req,omitempty"`
...
func (x *TicketInfo) GetConfirmReq() *ReqInfo {
	if x != nil {
		return x.ConfirmReq
	}
	return nil
...
var file_service_proto_rawDesc = []byte{
	...
	0x6b, 0x65, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x22, 0xba, 0x01,
	0x0a, 0x0a, 0x54, 0x69, 0x63, 0x6b, 0x65, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x31, 0x0a, 0x0b,
	0x63, 0x6f, 0x6e, 0x66, 0x69, 0x72, 0x6d, 0x5f, 0x72, 0x65, 0x71, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x10, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x52, 0x65, 0x71, 0x49,
	0x6e, 0x66, 0x6f, 0x52, 0x0a, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x72, 0x6d, 0x52, 0x65, 0x71, 0x12,
	...
	0x65, 0x64, 0x10, 0x03, 0x32, 0x89, 0x06, 0x0a, 0x07, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	0x00, 0x12, 0x4a, 0x0a, 0x10, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x54, 0x69, 0x63, 0x6b, 0x65, 0x74,
	0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x16, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e,
	0x54, 0x69, 0x63, 0x6b, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1c, 0x2e,
	0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x54, 0x69, 0x63, 0x6b, 0x65, 0x74, 0x53, 0x74,
	0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x41, 0x0a,
	0x0c, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x54, 0x69, 0x63, 0x6b, 0x65, 0x74, 0x12, 0x16, 0x2e,
...
var file_service_proto_goTypes = []interface{}{
	...
	(*Status)(nil),                 // 1: message.Status
	(*DBTokenRequest)(nil),         // 2: message.DBTokenRequest
	(*DBTokenResponse)(nil),        // 3: message.DBTokenResponse
	(*SessionCreateRequest)(nil),   // 4: message.SessionCreateRequest
	(*SessionCreateResponse)(nil),  // 5: message.SessionCreateResponse
	(*SessionFinishRequest)(nil),   // 6: message.SessionFinishRequest
	(*SessionFinishResp)(nil),      // 7: message.SessionFinishResp
	(*ReplayRequest)(nil),          // 8: message.ReplayRequest
	(*ReplayResponse)(nil),         // 9: message.ReplayResponse
	(*CommandRequest)(nil),         // 10: message.CommandRequest
	(*CommandResponse)(nil),        // 11: message.CommandResponse
	(*FinishedTaskRequest)(nil),    // 12: message.FinishedTaskRequest
	(*TaskResponse)(nil),           // 13: message.TaskResponse
	(*RemainReplayRequest)(nil),    // 14: message.RemainReplayRequest
	(*RemainReplayResponse)(nil),   // 15: message.RemainReplayResponse
	(*StatusResponse)(nil),         // 16: message.StatusResponse
	(*CommandConfirmRequest)(nil),  // 17: message.CommandConfirmRequest
	(*ReqInfo)(nil),                // 18: message.ReqInfo
	(*CommandConfirmResponse)(nil), // 19: message.CommandConfirmResponse
	(*TicketInfo)(nil),             // 20: message.TicketInfo
	(*TicketRequest)(nil),          // 21: message.TicketRequest
	(*TicketStateResponse)(nil),    // 22: message.TicketStateResponse
	(*TicketState)(nil),            // 23: message.TicketState
	(*DBTokenAuthInfo)(nil),        // 24: message.DBTokenAuthInfo
	(*Session)(nil),                // 25: message.Session
	(RiskLevel)(0),                 // 26: message.RiskLevel
	(*TerminalTask)(nil),           // 27: message.TerminalTask
}
var file_service_proto_depIdxs = []int32{
	1,  // 0: message.DBTokenResponse.status:type_name -> message.Status
	24, // 1: message.DBTokenResponse.data:type_name -> message.DBTokenAuthInfo
	25, // 2: message.SessionCreateRequest.data:type_name -> message.Session
	1,  // 3: message.SessionCreateResponse.status:type_name -> message.Status
	25, // 4: message.SessionCreateResponse.data:type_name -> message.Session
	1,  // 5: message.SessionFinishResp.status:type_name -> message.Status
	1,  // 6: message.ReplayResponse.status:type_name -> message.Status
	26, // 7: message.CommandRequest.risk_level:type_name -> message.RiskLevel
	1,  // 8: message.CommandResponse.status:type_name -> message.Status
	27, // 9: message.TaskResponse.task:type_name -> message.TerminalTask
	1,  // 10: message.RemainReplayResponse.status:type_name -> message.Status
	1,  // 11: message.StatusResponse.status:type_name -> message.Status
	1,  // 12: message.CommandConfirmResponse.status:type_name -> message.Status
	20, // 13: message.CommandConfirmResponse.info:type_name -> message.TicketInfo
	18, // 14: message.TicketInfo.confirm_req:type_name -> message.ReqInfo
	18, // 15: message.TicketInfo.cancel_req:type_name -> message.ReqInfo
	18, // 16: message.TicketRequest.req:type_name -> message.ReqInfo
	23, // 17: message.TicketStateResponse.Data:type_name -> message.TicketState
	1,  // 18: message.TicketStateResponse.status:type_name -> message.Status
	0,  // 19: message.TicketState.state:type_name -> message.TicketState.State
	2,  // 20: message.Service.GetDBTokenAuthInfo:input_type -> message.DBTokenRequest
	4,  // 21: message.Service.CreateSession:input_type -> message.SessionCreateRequest
	6,  // 22: message.Service.FinishSession:input_type -> message.SessionFinishRequest
	8,  // 23: message.Service.UploadReplayFile:input_type -> message.ReplayRequest
	10, // 24: message.Service.UploadCommand:input_type -> message.CommandRequest
	12, // 25: message.Service.DispatchTask:input_type -> message.FinishedTaskRequest
	14, // 26: message.Service.ScanRemainReplays:input_type -> message.RemainReplayRequest
	17, // 27: message.Service.CreateCommandTicket:input_type -> message.CommandConfirmRequest
	21, // 28: message.Service.CheckTicketState:input_type -> message.TicketRequest
	21, // 29: message.Service.CancelTicket:input_type -> message.TicketRequest
	3,  // 30: message.Service.GetDBTokenAuthInfo:output_type -> message.DBTokenResponse
	5,  // 31: message.Service.CreateSession:output_type -> message.SessionCreateResponse
	7,  // 32: message.Service.FinishSession:output_type -> message.SessionFinishResp
	9,  // 33: message.Service.UploadReplayFile:output_type -> message.ReplayResponse
	11, // 34: message.Service.UploadCommand:output_type -> message.CommandResponse
	13, // 35: message.Service.DispatchTask:output_type -> message.TaskResponse
	15, // 36: message.Service.ScanRemainReplays:output_type -> message.RemainReplayResponse
	19, // 37: message.Service.CreateCommandTicket:output_type -> message.CommandConfirmResponse
	22, // 38: message.Service.CheckTicketState:output_type -> message.TicketStateResponse
	16, // 39: message.Service.CancelTicket:output_type -> message.StatusResponse
