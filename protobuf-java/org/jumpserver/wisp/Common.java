...
public final class Common {
  ...
  public interface DataMaskingRuleOrBuilder extends
      // @@protoc_insertion_point(interface_extends:message.DataMaskingRule)
      com.google.protobuf.MessageOrBuilder {
    ...
    /**
     * <code>string masking_method = 5;</code>
     * @return The maskingMethod.
     */
    java.lang.String getMaskingMethod();
    /**
     * <code>string masking_method = 5;</code>
     * @return The bytes for maskingMethod.
     */
    com.google.protobuf.ByteString
        getMaskingMethodBytes();

    /**
     * <code>string mask_pattern = 6;</code>
     * @return The maskPattern.
     */
    java.lang.String getMaskPattern();
    /**
     * <code>string mask_pattern = 6;</code>
     * @return The bytes for maskPattern.
     */
    com.google.protobuf.ByteString
        getMaskPatternBytes();

    /**
     * <code>string fields_pattern = 7;</code>
     * @return The fieldsPattern.
     */
    java.lang.String getFieldsPattern();
    /**
     * <code>string fields_pattern = 7;</code>
     * @return The bytes for fieldsPattern.
     */
    com.google.protobuf.ByteString
        getFieldsPatternBytes();
  }
  /**
   * Protobuf type {@code message.DataMaskingRule}
   */
  public static final class DataMaskingRule extends
      com.google.protobuf.GeneratedMessage implements
      // @@protoc_insertion_point(message_implements:message.DataMaskingRule)
      DataMaskingRuleOrBuilder {
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        com.google.protobuf.RuntimeVersion.RuntimeDomain.PUBLIC,
        ...
        /* patch= */ 2,
        /* suffix= */ "",
        DataMaskingRule.class.getName());
    }
    // Use DataMaskingRule.newBuilder() to construct.
    private DataMaskingRule(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public static final int MASKING_METHOD_FIELD_NUMBER = 5;
    @SuppressWarnings("serial")
    private volatile java.lang.Object maskingMethod_ = "";
    /**
     * <code>string masking_method = 5;</code>
     * @return The maskingMethod.
     */
    @java.lang.Override
    public java.lang.String getMaskingMethod() {
    ...
    public static final int MASK_PATTERN_FIELD_NUMBER = 6;
    @SuppressWarnings("serial")
    private volatile java.lang.Object maskPattern_ = "";
    /**
     * <code>string mask_pattern = 6;</code>
     * @return The maskPattern.
     */
    ...
    public static final int FIELDS_PATTERN_FIELD_NUMBER = 7;
    @SuppressWarnings("serial")
    private volatile java.lang.Object fieldsPattern_ = "";
    /**
     * <code>string fields_pattern = 7;</code>
     * @return The fieldsPattern.
     */
    @java.lang.Override
    public java.lang.String getFieldsPattern() {
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(maskingMethod_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 5, maskingMethod_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(maskPattern_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 6, maskPattern_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(fieldsPattern_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 7, fieldsPattern_);
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(maskingMethod_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(5, maskingMethod_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(maskPattern_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(6, maskPattern_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(fieldsPattern_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(7, fieldsPattern_);
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSize = size;
      return size;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getIsActive()
          != other.getIsActive()) return false;
      if (!getMaskingMethod()
          .equals(other.getMaskingMethod())) return false;
      if (!getMaskPattern()
          .equals(other.getMaskPattern())) return false;
      if (!getFieldsPattern()
          .equals(other.getFieldsPattern())) return false;
      if (!getUnknownFields().equals(other.getUnknownFields())) return false;
      return true;
    }
    ...
    public int hashCode() {
      ...
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getIsActive());
      hash = (37 * hash) + MASKING_METHOD_FIELD_NUMBER;
      hash = (53 * hash) + getMaskingMethod().hashCode();
      hash = (37 * hash) + MASK_PATTERN_FIELD_NUMBER;
      hash = (53 * hash) + getMaskPattern().hashCode();
      hash = (37 * hash) + FIELDS_PATTERN_FIELD_NUMBER;
      hash = (53 * hash) + getFieldsPattern().hashCode();
      hash = (29 * hash) + getUnknownFields().hashCode();
      memoizedHashCode = hash;
      return hash;
    }
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(org.jumpserver.wisp.Common.DataMaskingRule result) {
        ...
        if (((from_bitField0_ & 0x00000010) != 0)) {
          result.maskingMethod_ = maskingMethod_;
        }
        if (((from_bitField0_ & 0x00000020) != 0)) {
          result.maskPattern_ = maskPattern_;
        }
        if (((from_bitField0_ & 0x00000040) != 0)) {
          result.fieldsPattern_ = fieldsPattern_;
        }
      }
      ...
      public Builder mergeFrom(org.jumpserver.wisp.Common.DataMaskingRule other) {
        ...
        if (!other.getMaskingMethod().isEmpty()) {
          maskingMethod_ = other.maskingMethod_;
          bitField0_ |= 0x00000010;
          onChanged();
        }
        if (!other.getMaskPattern().isEmpty()) {
          maskPattern_ = other.maskPattern_;
          bitField0_ |= 0x00000020;
          onChanged();
        }
        if (!other.getFieldsPattern().isEmpty()) {
          fieldsPattern_ = other.fieldsPattern_;
          bitField0_ |= 0x00000040;
          onChanged();
        }
        this.mergeUnknownFields(other.getUnknownFields());
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 42: {
                maskingMethod_ = input.readStringRequireUtf8();
                bitField0_ |= 0x00000010;
                break;
              } // case 42
              case 50: {
                maskPattern_ = input.readStringRequireUtf8();
                bitField0_ |= 0x00000020;
                break;
              } // case 50
              case 58: {
                fieldsPattern_ = input.readStringRequireUtf8();
                bitField0_ |= 0x00000040;
                break;
              } // case 58
              default: {
      ...
      private java.lang.Object maskingMethod_ = "";
      /**
       * <code>string masking_method = 5;</code>
       * @return The maskingMethod.
       */
      ...
      /**
       * <code>string masking_method = 5;</code>
       * @param value The maskingMethod to set.
       * @return This builder for chaining.
       */
      public Builder setMaskingMethod(
          java.lang.String value) {
        if (value == null) { throw new NullPointerException(); }
        maskingMethod_ = value;
        bitField0_ |= 0x00000010;
        onChanged();
        return this;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder clearMaskingMethod() {
        maskingMethod_ = getDefaultInstance().getMaskingMethod();
        bitField0_ = (bitField0_ & ~0x00000010);
        onChanged();
        return this;
      }
      /**
       * <code>string masking_method = 5;</code>
       * @param value The bytes for maskingMethod to set.
       * @return This builder for chaining.
       */
      public Builder setMaskingMethodBytes(
          com.google.protobuf.ByteString value) {
        if (value == null) { throw new NullPointerException(); }
        checkByteStringIsUtf8(value);
        maskingMethod_ = value;
      ...
      private java.lang.Object maskPattern_ = "";
      /**
       * <code>string mask_pattern = 6;</code>
       * @return The maskPattern.
       */
      ...
      /**
       * <code>string mask_pattern = 6;</code>
       * @param value The maskPattern to set.
       * @return This builder for chaining.
       */
      public Builder setMaskPattern(
          java.lang.String value) {
        if (value == null) { throw new NullPointerException(); }
        maskPattern_ = value;
        bitField0_ |= 0x00000020;
       ...
       * @return This builder for chaining.
       */
      public Builder clearMaskPattern() {
        maskPattern_ = getDefaultInstance().getMaskPattern();
        bitField0_ = (bitField0_ & ~0x00000020);
        onChanged();
        return this;
      }
      /**
       * <code>string mask_pattern = 6;</code>
       * @param value The bytes for maskPattern to set.
       * @return This builder for chaining.
       */
      public Builder setMaskPatternBytes(
          com.google.protobuf.ByteString value) {
        if (value == null) { throw new NullPointerException(); }
        checkByteStringIsUtf8(value);
        maskPattern_ = value;
      ...
      private java.lang.Object fieldsPattern_ = "";
      /**
       * <code>string fields_pattern = 7;</code>
       * @return The fieldsPattern.
       */
      ...
      /**
       * <code>string fields_pattern = 7;</code>
       * @param value The fieldsPattern to set.
       * @return This builder for chaining.
       */
      public Builder setFieldsPattern(
          java.lang.String value) {
        if (value == null) { throw new NullPointerException(); }
        fieldsPattern_ = value;
        bitField0_ |= 0x00000040;
        onChanged();
        return this;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder clearFieldsPattern() {
        fieldsPattern_ = getDefaultInstance().getFieldsPattern();
        bitField0_ = (bitField0_ & ~0x00000040);
        onChanged();
        return this;
      }
      /**
       * <code>string fields_pattern = 7;</code>
       * @param value The bytes for fieldsPattern to set.
       * @return This builder for chaining.
       */
      public Builder setFieldsPatternBytes(
          com.google.protobuf.ByteString value) {
        if (value == null) { throw new NullPointerException(); }
        checkByteStringIsUtf8(value);
        fieldsPattern_ = value;
      ...
      // @@protoc_insertion_point(builder_scope:message.DataMaskingRule)
    }
    ...
    private static final com.google.protobuf.Parser<DataMaskingRule>
        PARSER = new com.google.protobuf.AbstractParser<DataMaskingRule>() {
      @java.lang.Override
      public DataMaskingRule parsePartialFrom(
          com.google.protobuf.CodedInputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws com.google.protobuf.InvalidProtocolBufferException {
        Builder builder = newBuilder();
    ...
    public static com.google.protobuf.Parser<DataMaskingRule> parser() {
      return PARSER;
    }

    @java.lang.Override
    public com.google.protobuf.Parser<DataMaskingRule> getParserForType() {
      return PARSER;
    }
  ...
  public interface TokenAuthInfoOrBuilder extends
     ...
     * @return The faceMonitorToken.
     */
    java.lang.String getFaceMonitorToken();
    /**
     * <code>string FaceMonitorToken = 12;</code>
     * @return The bytes for faceMonitorToken.
     */
    com.google.protobuf.ByteString
  ...
  private static final long serialVersionUID = 0L;
    ...
    private TokenAuthInfo() {
      ...
      faceMonitorToken_ = "";
      dataMaskingRules_ = java.util.Collections.emptyList();
    }
    ...
    @SuppressWarnings("serial")
    private volatile java.lang.Object faceMonitorToken_ = "";
    /**
     * <code>string FaceMonitorToken = 12;</code>
     * @return The faceMonitorToken.
     */
    @java.lang.Override
    public java.lang.String getFaceMonitorToken() {
     ...
     */
    @java.lang.Override
    public int getDataMaskingRulesCount() {
      return dataMaskingRules_.size();
    }
    /**
     * <code>repeated .message.DataMaskingRule data_masking_rules = 13;</code>
     */
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(faceMonitorToken_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 12, faceMonitorToken_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(faceMonitorToken_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(12, faceMonitorToken_);
      }
      for (int i = 0; i < dataMaskingRules_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + FACEMONITORTOKEN_FIELD_NUMBER;
      hash = (53 * hash) + getFaceMonitorToken().hashCode();
    ...
    public static final class Builder extends
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessage
          ...
          getDataMaskingRulesFieldBuilder();
        }
      }
      @java.lang.Override
      public Builder clear() {
      ...
      private void buildPartialRepeatedFields(org.jumpserver.wisp.Common.TokenAuthInfo result) {
        ...
        if (dataMaskingRulesBuilder_ == null) {
          if (((bitField0_ & 0x00001000) != 0)) {
            dataMaskingRules_ = java.util.Collections.unmodifiableList(dataMaskingRules_);
            bitField0_ = (bitField0_ & ~0x00001000);
          }
          result.dataMaskingRules_ = dataMaskingRules_;
        } else {
          result.dataMaskingRules_ = dataMaskingRulesBuilder_.build();
        }
      }
      ...
      public Builder mergeFrom(org.jumpserver.wisp.Common.TokenAuthInfo other) {
        ...
        if (dataMaskingRulesBuilder_ == null) {
          if (!other.dataMaskingRules_.isEmpty()) {
            if (dataMaskingRules_.isEmpty()) {
              dataMaskingRules_ = other.dataMaskingRules_;
              bitField0_ = (bitField0_ & ~0x00001000);
            } else {
              ensureDataMaskingRulesIsMutable();
              dataMaskingRules_.addAll(other.dataMaskingRules_);
            }
            onChanged();
          }
        } else {
          if (!other.dataMaskingRules_.isEmpty()) {
            if (dataMaskingRulesBuilder_.isEmpty()) {
              dataMaskingRulesBuilder_.dispose();
              dataMaskingRulesBuilder_ = null;
              dataMaskingRules_ = other.dataMaskingRules_;
              bitField0_ = (bitField0_ & ~0x00001000);
              dataMaskingRulesBuilder_ = 
                com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders ?
                   getDataMaskingRulesFieldBuilder() : null;
            } else {
              dataMaskingRulesBuilder_.addAllMessages(other.dataMaskingRules_);
            }
          }
        }
        this.mergeUnknownFields(other.getUnknownFields());
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 98: {
                faceMonitorToken_ = input.readStringRequireUtf8();
                bitField0_ |= 0x00000800;
                break;
              } // case 98
              case 106: {
                ...
                if (dataMaskingRulesBuilder_ == null) {
                  ensureDataMaskingRulesIsMutable();
                  dataMaskingRules_.add(m);
                } else {
                  dataMaskingRulesBuilder_.addMessage(m);
                }
                break;
              } // case 106
              default: {
      ...
      private java.lang.Object faceMonitorToken_ = "";
      /**
       * <code>string FaceMonitorToken = 12;</code>
       * @return The faceMonitorToken.
       */
      ...
      /**
       * <code>string FaceMonitorToken = 12;</code>
       * @param value The faceMonitorToken to set.
       * @return This builder for chaining.
       */
      public Builder setFaceMonitorToken(
          java.lang.String value) {
        if (value == null) { throw new NullPointerException(); }
        faceMonitorToken_ = value;
        bitField0_ |= 0x00000800;
        onChanged();
        return this;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder clearFaceMonitorToken() {
        faceMonitorToken_ = getDefaultInstance().getFaceMonitorToken();
        bitField0_ = (bitField0_ & ~0x00000800);
        onChanged();
        return this;
      }
      /**
       * <code>string FaceMonitorToken = 12;</code>
       * @param value The bytes for faceMonitorToken to set.
       * @return This builder for chaining.
       */
      public Builder setFaceMonitorTokenBytes(
          com.google.protobuf.ByteString value) {
        if (value == null) { throw new NullPointerException(); }
        checkByteStringIsUtf8(value);
        faceMonitorToken_ = value;
      ...
      public java.util.List<org.jumpserver.wisp.Common.DataMaskingRule> getDataMaskingRulesList() {
        if (dataMaskingRulesBuilder_ == null) {
          ...
          return dataMaskingRulesBuilder_.getMessageList();
        }
      }
      /**
       * <code>repeated .message.DataMaskingRule data_masking_rules = 13;</code>
      ...
      public int getDataMaskingRulesCount() {
        if (dataMaskingRulesBuilder_ == null) {
          ...
          return dataMaskingRulesBuilder_.getCount();
        }
      }
      /**
       * <code>repeated .message.DataMaskingRule data_masking_rules = 13;</code>
      ...
      public org.jumpserver.wisp.Common.DataMaskingRule getDataMaskingRules(int index) {
        if (dataMaskingRulesBuilder_ == null) {
          ...
          return dataMaskingRulesBuilder_.getMessage(index);
        }
      }
      /**
       * <code>repeated .message.DataMaskingRule data_masking_rules = 13;</code>
      ...
      public Builder setDataMaskingRules(
        ...
        if (dataMaskingRulesBuilder_ == null) {
          ...
          ensureDataMaskingRulesIsMutable();
          dataMaskingRules_.set(index, value);
          onChanged();
        } else {
          dataMaskingRulesBuilder_.setMessage(index, value);
        }
        return this;
      }
      /**
      ...
      public Builder setDataMaskingRules(
        ...
        if (dataMaskingRulesBuilder_ == null) {
          ...
          dataMaskingRulesBuilder_.setMessage(index, builderForValue.build());
        }
        return this;
      }
      /**
      ...
      public Builder addDataMaskingRules(org.jumpserver.wisp.Common.DataMaskingRule value) {
        if (dataMaskingRulesBuilder_ == null) {
          ...
          ensureDataMaskingRulesIsMutable();
          dataMaskingRules_.add(value);
          onChanged();
        } else {
          dataMaskingRulesBuilder_.addMessage(value);
        }
        return this;
      }
      /**
      ...
      public Builder addDataMaskingRules(
        ...
        if (dataMaskingRulesBuilder_ == null) {
          ...
          ensureDataMaskingRulesIsMutable();
          dataMaskingRules_.add(index, value);
          onChanged();
        } else {
          dataMaskingRulesBuilder_.addMessage(index, value);
        }
        return this;
      }
      /**
      ...
      public Builder addDataMaskingRules(
        ...
        if (dataMaskingRulesBuilder_ == null) {
          ...
          dataMaskingRulesBuilder_.addMessage(builderForValue.build());
        }
        return this;
      }
      /**
      ...
      public Builder addDataMaskingRules(
        ...
        if (dataMaskingRulesBuilder_ == null) {
          ...
          dataMaskingRulesBuilder_.addMessage(index, builderForValue.build());
        }
        return this;
      }
      /**
      ...
      public Builder addAllDataMaskingRules(
        ...
        if (dataMaskingRulesBuilder_ == null) {
          ensureDataMaskingRulesIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
              values, dataMaskingRules_);
          onChanged();
        } else {
          dataMaskingRulesBuilder_.addAllMessages(values);
        }
        return this;
      }
      /**
       * <code>repeated .message.DataMaskingRule data_masking_rules = 13;</code>
       */
      public Builder clearDataMaskingRules() {
        if (dataMaskingRulesBuilder_ == null) {
          dataMaskingRules_ = java.util.Collections.emptyList();
          bitField0_ = (bitField0_ & ~0x00001000);
          onChanged();
       ...
       * <code>repeated .message.DataMaskingRule data_masking_rules = 13;</code>
       */
      public Builder removeDataMaskingRules(int index) {
        if (dataMaskingRulesBuilder_ == null) {
          ensureDataMaskingRulesIsMutable();
          dataMaskingRules_.remove(index);
          onChanged();
        } else {
          dataMaskingRulesBuilder_.remove(index);
        }
        return this;
      }
      /**
      ...
      public org.jumpserver.wisp.Common.DataMaskingRule.Builder getDataMaskingRulesBuilder(
          int index) {
        return getDataMaskingRulesFieldBuilder().getBuilder(index);
      }
      /**
       * <code>repeated .message.DataMaskingRule data_masking_rules = 13;</code>
       */
      public org.jumpserver.wisp.Common.DataMaskingRuleOrBuilder getDataMaskingRulesOrBuilder(
        ...
        if (dataMaskingRulesBuilder_ == null) {
          ...
          return dataMaskingRulesBuilder_.getMessageOrBuilder(index);
        }
      }
      /**
       * <code>repeated .message.DataMaskingRule data_masking_rules = 13;</code>
      ...
      public org.jumpserver.wisp.Common.DataMaskingRule.Builder addDataMaskingRulesBuilder() {
        return getDataMaskingRulesFieldBuilder().addBuilder(
      ...
      public java.util.List<org.jumpserver.wisp.Common.DataMaskingRule.Builder> 
        ...
        return getDataMaskingRulesFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
...
java.lang.String defaultValue) {
  ...
  public interface PublicSettingOrBuilder extends
    ...
    /**
     * <code>string license_content = 7;</code>
     * @return The bytes for licenseContent.
     */
    com.google.protobuf.ByteString
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int LICENSE_CONTENT_FIELD_NUMBER = 7;
    @SuppressWarnings("serial")
    private volatile java.lang.Object licenseContent_ = "";
    /**
     * <code>string license_content = 7;</code>
     * @return The licenseContent.
     */
    ...
    public static final class Builder extends
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 58: {
                licenseContent_ = input.readStringRequireUtf8();
                bitField0_ |= 0x00000040;
                break;
              } // case 58
              default: {
      ...
      private java.lang.Object licenseContent_ = "";
      /**
       * <code>string license_content = 7;</code>
       * @return The licenseContent.
       */
      ...
      /**
       * <code>string license_content = 7;</code>
       * @param value The licenseContent to set.
       * @return This builder for chaining.
       */
      ...
      /**
       * <code>string license_content = 7;</code>
       * @param value The bytes for licenseContent to set.
       * @return This builder for chaining.
       */
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ning\020\003\022\021\n\rNotifyWarning\020\004\022\013\n\007Unknown\020\005\"\226" +
      "\001\n\017DataMaskingRule\022\n\n\002id\030\001 \001(\t\022\014\n\004name\030\002" +
      " \001(\t\022\020\n\010priority\030\003 \001(\005\022\021\n\tis_active\030\004 \001(" +
      "\010\022\026\n\016masking_method\030\005 \001(\t\022\024\n\014mask_patter" +
      ...
      "\004 \001(\t\022.\n\nlogin_from\030\005 \001(\0162\032.message.Sess" +
      "ion.LoginFrom\022\023\n\013remote_addr\030\006 \001(\t\022\020\n\010pr" +
      "otocol\030\007 \001(\t\022\022\n\ndate_start\030\010 \001(\003\022\016\n\006org_" +
      "id\030\t \001(\t\022\017\n\007user_id\030\n \001(\t\022\020\n\010asset_id\030\013 " +
      ...
      "etail\030\002 \001(\t\022\022\n\nis_expired\030\003 \001(\010\"\252\001\n\014Term" +
      "inalTask\022\n\n\002id\030\001 \001(\t\022#\n\006action\030\002 \001(\0162\023.m" +
    ...
    internal_static_message_DataMaskingRule_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessage.FieldAccessorTable(
        internal_static_message_DataMaskingRule_descriptor,
        new java.lang.String[] { "Id", "Name", "Priority", "IsActive", "MaskingMethod", "MaskPattern", "FieldsPattern", });
    internal_static_message_CommandGroup_descriptor =
